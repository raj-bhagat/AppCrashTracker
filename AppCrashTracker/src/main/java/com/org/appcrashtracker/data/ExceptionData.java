...
public class ExceptionData {
    ...
    private ZSONObject jsonObjectData = new ZSONObject();

    /** Set the conditions of the details required */
    public void setBoolean(Ability ability) throws NotExistException, WrongTypeException, IOException {
    ...
    public void populateJSONObject( Throwable exception, StringWriter stackTrace, Ability ability) {
        if (packageName) {
        ...
        setDeviceInfo(jsonObjectData, ability);
        setScreenOrientationAndLayout(jsonObjectData, ability);
        setInternalExternalMemoryValues(jsonObjectData, ability);
        setBatteryValues(jsonObjectData);
        setMemoryValues(jsonObjectData, ability);
    }

    /** setting the device info in json file */
    private void setDeviceInfo(ZSONObject jsonObjectData, Ability ability) {
    ...
    private void setScreenOrientationAndLayout(ZSONObject jsonObjectData, Ability ability) {
    ...
    private void setBatteryValues(ZSONObject jsonObjectData) {
    ...
    private void setInternalExternalMemoryValues(ZSONObject jsonObjectData, Ability ability) {
        if (sdCardStatus) {
    ...
    public void setMemoryValues(ZSONObject jsonObjectData, Ability ability) {
        if (vmHeapSize) {
            jsonObjectData.put("VM_Heap_Size", getConvertSize(Runtime.getRuntime().totalMemory()));
        }
        if (country) {
